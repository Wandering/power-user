...
public class DESUtil {
    ...
    //DES key长度必须为8的整数倍
    public static final String key = "ppower@2017token";
    /**
     *   
     * 生成密钥key对象
     * @param keyStr 密钥字符串
...
//    }
    ...
    public static String getEightByteMultypleStr(Long id, Long agencyId,String openId)
    {
    	StringBuffer buffer = new StringBuffer();
    	buffer.append(id).append("@@").append(agencyId).append("@@").append(openId);
