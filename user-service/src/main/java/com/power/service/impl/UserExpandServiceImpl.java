...
@Service("UserExpandServiceImpl")
public class UserExpandServiceImpl extends AbstractPageService<Long, IUserExpandDAO, UserExpand> implements IUserExpandService {
    @Autowired
    private IUserExpandDAO userExpandDAO;

    @Override
    public IUserExpandDAO getDao() {
