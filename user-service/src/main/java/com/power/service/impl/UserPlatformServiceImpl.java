...
@Service("UserPlatformServiceImpl")
public class UserPlatformServiceImpl extends AbstractPageService<Long, IUserPlatformDAO, UserPlatform> implements IUserPlatformService {
    @Autowired
    private IUserPlatformDAO userPlatformDAO;

    @Override
    public IUserPlatformDAO getDao() {
...
//        return userPlatformDAO.findAll();
//    }
//
//    @Override
...
//
//    @Override
//    protected UserPlatformDAO getDao() {
//        return userPlatformDAO;
//    }
//
//    @Override
