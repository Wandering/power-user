...
@Service("OrderLineServiceImpl")
public class OrderLineServiceImpl extends AbstractPageService<Long, IOrderLineDAO, OrderLine> implements IOrderLineService {
    @Autowired
    private IOrderLineDAO orderLineDAO;

    @Override
    public IOrderLineDAO getDao() {
        return orderLineDAO;
    }
